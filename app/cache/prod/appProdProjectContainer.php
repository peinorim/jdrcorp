...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/assetic/config'), false)));
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
        return $instance;
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_92fa0cbf7a9fcb6cd4c35e969a3207f9');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_92fa0cbf7a9fcb6cd4c35e969a3207f9');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_92fa0cbf7a9fcb6cd4c35e969a3207f9');
        ...
        $d->setProxyDir('C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        $instance->addExtension(new \Symfony\Bundle\SecurityBundle\Twig\Extension\LogoutUrlExtension($this->get('templating.helper.logout_url')));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\SecurityExtension($this->get('security.context', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\TranslationExtension($this->get('translator')));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\AssetsExtension($this));
        $instance->addExtension(new \Symfony\Bundle\TwigBundle\Extension\ActionsExtension($this));
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\Symfony\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\Symfony\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\Symfony\\src\\JdrCorp\\ElricBundle/Resources/views', 'JdrCorpElric');
        $instance->addPath('C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/Resources/views');
        $instance->addPath('C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
        return $instance;
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app',
            'kernel.environment' => 'prod',
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod',
            'kernel.logs_dir' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/logs',
            ...
            'session.save_path' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'router.resource' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/assetic',
            ...
            'assetic.read_from' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/../web',
            'assetic.write_to' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Program Files (x86)/EasyPHP-DevServer-13.1VC11/data/localweb/Symfony/app/cache/prod/doctrine/orm/Proxies',
