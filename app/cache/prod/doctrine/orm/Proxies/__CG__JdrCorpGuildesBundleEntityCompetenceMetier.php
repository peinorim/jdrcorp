 ...
 */
class CompetenceMetier extends \JdrCorp\GuildesBundle\Entity\CompetenceMetier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'JdrCorp\\GuildesBundle\\Entity\\CompetenceMetier' . "\0" . 'id', '' . "\0" . 'JdrCorp\\GuildesBundle\\Entity\\CompetenceMetier' . "\0" . 'competence', '' . "\0" . 'JdrCorp\\GuildesBundle\\Entity\\CompetenceMetier' . "\0" . 'metier');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompetenceMetier $proxy) {
