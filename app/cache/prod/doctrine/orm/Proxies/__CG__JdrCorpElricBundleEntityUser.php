 ...
 */
class User extends \JdrCorp\ElricBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'JdrCorp\\ElricBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'JdrCorp\\ElricBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'JdrCorp\\ElricBundle\\Entity\\User' . "\0" . 'useremail', '' . "\0" . 'JdrCorp\\ElricBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'JdrCorp\\ElricBundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'JdrCorp\\ElricBundle\\Entity\\User' . "\0" . 'roles');
        }
