 ...
 */
class Chapitre extends \JdrCorp\GuildesBundle\Entity\Chapitre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'JdrCorp\\GuildesBundle\\Entity\\Chapitre' . "\0" . 'id', '' . "\0" . 'JdrCorp\\GuildesBundle\\Entity\\Chapitre' . "\0" . 'nom');
        }
